...
string TimePassedNotification::NAME="TimePassedNotification";
void TimePassedNotification::Init(Handle<Object> exports){
    Isolate* isolate = Isolate::GetCurrent();
    // Prepare constructor template
    Local<FunctionTemplate> tpl = FunctionTemplate::New(isolate);
    tpl->SetClassName(String::NewFromUtf8(isolate, TimePassedNotification::NAME.c_str()));
    ...
    provider->setObjectConstructor(TimePassedNotification::NAME.c_str(),tpl->GetFunction());
    provider->setObjectTemplate(TimePassedNotification::NAME.c_str(), tpl->InstanceTemplate());
    exports->Set(String::NewFromUtf8(isolate, TimePassedNotification::NAME.c_str()), tpl->GetFunction());
}
